...
public class Memocontroller {
	...
	public String memo_write(@ModelAttribute MemoVO memoVO, @RequestParam("m_file") MultipartFile upFile ,Model model) {
	...
	public String memo_update(@ModelAttribute MemoVO memoVO, Model model) {
